...
```
_<program> ::= {<declaration>}_
<declaration> ::= <variable-declaration> | <function-declaration>
_<variable-declaration> ::= {<specifier>}+ <identifier> ["=" <exp>] ";"_
_<function-declaration> ::= {<specifier>}+ <identifier> "(" <param-list> ")" (<block> | ";")_
_<specifier> ::= "int" | "static" | "extern"_
